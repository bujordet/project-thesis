...
This thesis is \textit{not} to do a comparative analysis on LP between the ICT-industry and the CI, rather explore the reasons causing the phenomenon. Hence the selected singe case object. 
